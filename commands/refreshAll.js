...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('refreshall')
        .setDescription('Refresh and resend the latest cancelled lectures embed to all channels'),
    async execute(interaction) {
        ...
        try {
            ...
            if (embed) {
                ...
                await interaction.reply({ content: 'The cancelled lectures embed has been updated in all channels.', ephemeral: true });
            } else {
